package ru.mihail_tarasov.licensing_service.service;
...
public class LicenseService {
    ...
    public String deleteLicense(String licenseId, String organizationId){
        String responseMessage=null;
        responseMessage=String.format("Deleting license with id %s for the organisation %s",licenseId,organizationId);
        return responseMessage;
    }
